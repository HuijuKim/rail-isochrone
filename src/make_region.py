...
AREAS = [
    ({"ja": "北海道", "en": "Hokkaido", "ko": "홋카이도",
      "zh-Hans": "北海道", "zh-Hant": "北海道"}, ["北海道"]),
    ({"ja": "東北", "en": "Tohoku", "ko": "도호쿠", "zh-Hans": "东北", "zh-Hant": "東北"},
     ["青森県", "岩手県", "宮城県", "秋田県", "山形県", "福島県"]),
    ({"ja": "関東", "en": "Kanto", "ko": "간토", "zh-Hans": "关东", "zh-Hant": "關東"},
     ["茨城県", "栃木県", "群馬県", "埼玉県", "千葉県", "東京都", "神奈川県"]),
    ({"ja": "甲信越", "en": "Koshinetsu", "ko": "고신에쓰",
      "zh-Hans": "甲信越", "zh-Hant": "甲信越"}, ["新潟県", "山梨県", "長野県"]),
    ({"ja": "北陸", "en": "Hokuriku", "ko": "호쿠리쿠",
      "zh-Hans": "北陆", "zh-Hant": "北陸"}, ["富山県", "石川県", "福井県"]),
    ({"ja": "東海", "en": "Tokai", "ko": "도카이",
      "zh-Hans": "东海", "zh-Hant": "東海"}, ["岐阜県", "静岡県", "愛知県", "三重県"]),
    ({"ja": "関西", "en": "Kansai", "ko": "간사이", "zh-Hans": "关西", "zh-Hant": "關西"},
     ["滋賀県", "京都府", "大阪府", "兵庫県", "奈良県", "和歌山県"]),
    # 중국어로 "中国" 은 나라 이름이라 地方 을 붙인다(주고쿠 권역과 같다).
    ({"ja": "中国", "en": "Chugoku", "ko": "주고쿠",
      "zh-Hans": "中国地方", "zh-Hant": "中國地方"},
     ["鳥取県", "島根県", "岡山県", "広島県", "山口県"]),
    ({"ja": "四国", "en": "Shikoku", "ko": "시코쿠",
      "zh-Hans": "四国", "zh-Hant": "四國"}, ["徳島県", "香川県", "愛媛県", "高知県"]),
    ({"ja": "九州・沖縄", "en": "Kyushu & Okinawa", "ko": "규슈·오키나와",
      "zh-Hans": "九州·冲绳", "zh-Hant": "九州·沖繩"},
...
def region_json(rid: str, prefs: list[str]) -> dict:
    ...
    meta = {
        ...
        "names": {"ja": ja,
                  ...
                  "zh-Hans": "·".join(PREFS[p]["zh-Hans"] for p in prefs),
                  "zh-Hant": "·".join(PREFS[p]["zh-Hant"] for p in prefs)},
        "model": "naive",
        "timetable": None,
